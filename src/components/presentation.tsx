    ...
    <div className="flex flex-col items-center h-full w-full justify-around gap-12 px-8">
      ...
      <p className="max-w-[60rem] text-center">
        ...
        <a
          ...
          target="_blank"
          className="font-bold text-emphasis-blue hover:text-black"
          rel="noreferrer"
        >
          {' '}
      ...
      <p className="max-w-[60rem] text-center">
        ...
        <i className="text-emphasis-blue"> killers, explorers, socializers, and achievers</i>
      </p>
      <p className="max-w-[60rem] text-center">
        In this quiz, you will be presented with
        <b className="text-emphasis-blue"> four open-ended questions </b>
        that will help us determine which type best fits your personality using a model with
        <b className="text-emphasis-blue">
          {' '}
          <a
      ...
      <p className="max-w-[60rem] text-center">
        The quiz will take
        {' '}
        <i className="text-emphasis-blue">less than 5 minutes</i>
        {' '}
      ...
      <button
        type="button"
        className="px-4 min-h-[3rem] bg-emphasis-blue text-neutral hover:bg-neutral hover:text-black rounded hover:border-2 hover:border-emphasis-blue"
      ...
      <small>
        by
        <i className="text-emphasis-blue">
          {' '}
          <a
